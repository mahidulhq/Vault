...
<head>
    ...
    <style>
        :root {
            ...
            --text-muted: #CBD5E1; /* Brightened for contrast */
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <div class="position-relative">
                    ...
                    <input type="text" name="username" class="form-control form-control-custom" placeholder="Enter your username" required autocomplete="off">
                </div>
            </div>
